...
public final class Constants {
    ...
    //users/search?access_token=5713483640.e4cb995.9bd923cc6a6a450785fd11a9fd6e6995&q={query}
    public static final String URL_SEARCH_USER = KEY_SEARCH_USER + KEY_ACCESS_TOKEN + ACCESS_TOKEN + KEY_Q + PARAM_QUERY;
